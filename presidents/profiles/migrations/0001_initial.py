# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-23 20:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(blank=True, editable=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ARI_display', models.CharField(default='Not Scored Yet.', max_length=100)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_left_office', models.CharField(blank=True, choices=[('NSR', 'Did Not Seek Re-election'), ('TME', 'Term Ended'), ('LRE', 'Lost'), ('DIO', 'Died in Office'), ('ASN', 'Assasinated'), ('RSG', 'Resigned'), ('IPH', 'Impeached')], max_length=3, null=True)),
            ],
        ...
        migrations.AlterUniqueTogether(
            name='speech',
            unique_together=set([('speaker', 'title', 'date')]),
        ),
    ]
